...
import { ChevronDown, ChevronRight, Sliders, Type, LayoutGrid, Paintbrush } from "lucide-react";
...
export const Properties: React.FC = () => {
  ...
  if (!node || !componentDef) {
    return (
      <div className="w-80 bg-[#1f2937]/95 border-l border-gray-800 flex flex-col h-full z-15 backdrop-blur shrink-0 select-none p-6 text-center justify-center space-y-3">
        <Sliders className="text-gray-600 mx-auto" size={32} />
        <h3 className="text-sm font-semibold text-gray-300">Style Manager</h3>
  ...
  return (
    <div className="w-88 bg-[#1f2937]/95 border-l border-gray-800 flex flex-col h-full z-15 backdrop-blur shrink-0 select-none">
      ...
      <div className="bg-gray-900/40 px-4 py-2 border-b border-gray-800/60 flex items-center justify-between text-xs text-gray-400">
