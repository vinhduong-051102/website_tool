...
export const PhoneInputComponent: BuilderComponent = {
  metadata: {
    type: "PhoneInput",
    name: "Phone Input",
    category: "Form",
  ...
  defaultProps: {
    ...
    allowClear: true,
    helperText: "",
    phoneValidation: true, // Enabled by default
  },
  defaultStyles: {},
  propertySchema: [
    ...commonFormProperties,
  ...
  codeGenerator: (node, children, styles) => {
    ...
    return `<Input type="tel"${size}${placeholder}${disabled}${readOnly}${allowClear} className="${styles || ""}" />`;
  },
};
