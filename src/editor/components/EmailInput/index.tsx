...
export const EmailInputComponent: BuilderComponent = {
  metadata: {
    type: "EmailInput",
    name: "Email Input",
    category: "Form",
  ...
  defaultProps: {
    ...
    allowClear: true,
    helperText: "",
    emailValidation: true, // Enabled by default
  },
  defaultStyles: {},
  propertySchema: [
    ...commonFormProperties,
  ...
  codeGenerator: (node, children, styles) => {
    ...
    return `<Input type="email"${size}${placeholder}${disabled}${readOnly}${allowClear} className="${styles || ""}" />`;
  },
};
